    ...
    file_exists(dirname(__FILE__) . '/appbanner.css'))
{
    $app_banner_head = '
        ...
        <link href="'.tt_html_escape($tapatalk_dir_url).'/smartbanner/appbanner.css" rel="stylesheet" type="text/css" media="screen" />
        <script type="text/javascript">
            ...
            var tapatalk_dir_name  = "'.tt_html_escape(basename(dirname(dirname(__FILE__)))).'";
        ...
        <script src="'.tt_html_escape($tapatalk_dir_url).'/smartbanner/appbanner.js" type="text/javascript"></script>
